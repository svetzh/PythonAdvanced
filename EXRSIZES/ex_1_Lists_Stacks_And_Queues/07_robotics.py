...
robots = {r.split("-")[0]: [int(r.split("-")[1]), 0] for r in input().split(";")}  # {name: [time_needed, time_for curr_task]}
...
while products:
    ...
    #         name: time_need, curr_task-1
    # if the robot is busy (!=0) subtract its time -1sec, else return current data and 0
